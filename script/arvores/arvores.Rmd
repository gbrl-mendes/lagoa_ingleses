...
asvs_to_remove <- c("ASV_204_85bp_merged|NA|NA|NA|NA",
...
dna_fasta_fil <- dna_fasta_or[!(names(dna_fasta_or) %>% str_detect(pattern = "Out")) & ## removendo as ASVs com "Out" no header
                                   ...
                                   !(names(dna_fasta_or) %>% str_detect(pattern = "ASV_192_158bp_merged|NA|NA|NA|Human DNA sequence from clone")) & 
                                   !(names(dna_fasta_or) %>% str_detect(pattern = "ASV_182_167bp_merged|NA|NA|NA|Cavia magna 12S ribosomal RNA")) & 
                                   !(names(dna_fasta_or) %>% str_detect(pattern = "ASV_106_169bp_merged|NA|NA|NA|Sus scrofa breed Andaman Desi"))]
...
dna_fasta_algn <- DECIPHER::AlignSeqs(myXStringSet = dna_fasta_fil, 
                                      refinements = 100,
                                      iterations = 100,
                                      verbose = TRUE)
