...
fish_ID_tbl_fasta <- pre_grouped_by_ID_BLASTid %>%
  ...
  unite(header, `ASV header`, `Final ID (BLASTn)`, sep = " | ",`BLASTn pseudo-score`) %>%  # Criando uma nova coluna com o cabeçalho da ASV e o nome de spp atribuido 
...
write(ASVs_all, "/home/gabriel/projetos/lagoa_ingleses/results/tree/2024/ASVs_all.fas") # Criando o arquivo


# Criando objeto Biostring para fazer alinhamento 

algn_in_ASVs_nofilt <- readDNAStringSet(filepath = "/home/gabriel/projetos/lagoa_ingleses/results/tree/2024/ASVs_all.fas")
...
BrowseSeqs(oriented_ASVs_out)

# Salvar as seqs orientadas
Biostrings::writeXStringSet(x = oriented_ASVs_out,
                            file =  "/home/gabriel/projetos/lagoa_ingleses/results/tree/2024/ASVs_oriented.fas")
